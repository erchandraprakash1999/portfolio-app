...
export const contactFormSchema = Yup.object({
  ...
  content: Yup.string().min(6).required('Please enter your content'),
  iagree: Yup.boolean().oneOf([true], 'Please agree to the terms and conditions').required('You must agree to the terms and conditions'),
});
